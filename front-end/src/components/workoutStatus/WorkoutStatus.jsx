...
const WorkoutStatus = ({ workoutReport, userName }) => {
    ...
    const deleteReport = async (id) => {
        try {
            await axios.delete(`http://localhost:8081/api/exercise-duration/delete/${id}`);
    ...
    const updateStartTime = async (id, newValue) => {
        try {
            const response = await axios.patch(
                `http://localhost:8081/api/exercise-duration/startTime/${workoutReport.id}/${newValue}`
            );
    ...
    const updateEndTime = async (id, newValue) => {
        try {
            const response = await axios.patch(
                `http://localhost:8081/api/exercise-duration/end-time/${workoutReport.id}/${newValue}`
            );
            alert("Start time updated successfully!");
            return response.data;
        } catch (error) {
    ...
    const updateCalories = async (id, newValue) => {
        try {
            const response = await axios.patch(
                `http://localhost:8081/api/exercise-duration/calories/${workoutReport.id}/${newValue}`
            );
            alert("Start time updated successfully!");
            return response.data;
        } catch (error) {
    ...
    const promptAndUpdate = async (exercise) => {
        ...
        if (newValue !== null && newValue.trim() !== "") {
            try {
                ...
                await axios.patch(`http://localhost:8081/api/exercise-duration/update-duration/${workoutReport.id}/${exercise}/${newValue}`);
