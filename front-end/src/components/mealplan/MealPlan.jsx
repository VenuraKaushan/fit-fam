...
const MealPlan = ({ meal, userName }) => {
  ...
  const deletePost = async (id) => {
    try {
        const response = await axios.delete(`http://localhost:8081/deleteMeal/${id}`);
  ...
  const updateDescription = async (id, newDescription) => {
    try {
        const response = await axios.patch(
            `http://localhost:8081/descriptionUpdateMeal/${id}/${newDescription}`
        );
  ...
  const updateName = async (id, newDescription) => {
    try {
        const response = await axios.patch(
            `http://localhost:8081/name/${id}/${newDescription}`
        );
  ...
  const updateRecipe = async (id, newDescription) => {
    try {
        const response = await axios.patch(
            `http://localhost:8081/recipe/${id}/${newDescription}`
        );
  ...
  const updateSchedule = async (id, newSchedule) => {
    try {
        const response = await axios.patch(
            `http://localhost:8081/schedule/${id}/${newSchedule}`
        );
  ...
  const updateNutrition = async (id, newNutrition) => {
    try {
        const response = await axios.patch(
            `http://localhost:8081/nutrition/${id}/${newNutrition}`
        );
